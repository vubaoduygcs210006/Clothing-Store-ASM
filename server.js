...
let serviceAccount = require("./ecom-website-store-firebase-adminsdk-qrth7-03d13ed017");
...
const bucketName = "ecom-website-store";
...
// declare static path
let staticPath = path.join(__dirname, "store");
...
app.post('/signup', (req, res) => {
    let { fullname, email, password, number, tac, notification } = req.body;
